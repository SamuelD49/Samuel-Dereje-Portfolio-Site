    ...
    <>
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
          <h2 className="text-center">Samuel Dereje</h2>
          <div className="flex">
            <a
              href="https://www.linkedin.com/in/samuel-dereje-293a4a23b/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/SamuelD49"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="py-6">
          <p className="italic">
            <span className="font-bold italic">DAN ENERGY ETHIOPIA</span>
            <span className="px-2">|</span>Addis Ababa, Ethiopia
          </p>
          <p className="py-1 italic">Lead Technologist</p>
          <ul className="list-disc list-outside px-7 py-1 leading-relaxed">
            <li>
              Help develop different projects assigned by the supervisors.
            </li>
